...
Config.Stores = {
	...
	[14] =  {x = -1207.65,     y = -1456.88,    z = 4.3784737586975},
...
Config.Outfits = {
    ["police"] = {
        [1] = {
            outfitLabel = "DSI Outfit",
            outfitData = {
                ["pants"]   = { item = 5, texture = 15},
                ["arms"]    = { item = 18, texture = 0},
                ["t-shirt"] = { item = 58, texture = 1},
                ["torso2"]  = { item = 220, texture = 6},
                ["shoes"]   = { item = 16, texture = 8},
                ["mask"]    = { item = 53, texture = 1},
                ["hat"]     = { item = 118, texture = 1},
