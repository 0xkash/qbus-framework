                        ...
                        if dist < 30 then
                            ...
                            if storeDist < 2 then
                                if not firstAlarm then
                                    if validWeapon() then
                                        TriggerServerEvent('qb-jewellery:server:PoliceAlertMessage', 'Er is een verdachte situatie bij Vangelico Juwelier', pos, true)
                                        firstAlarm = true
                                    end
                                end
                            end
...
function smashVitrine(k)
    ...
    QBCore.Functions.Progressbar("smash_vitrine", "Vitrine aan het inslaan..", Config.WhitelistedWeapons[pedWeapon]["timeOut"], false, true, {
        ...
        TriggerServerEvent('qb-jewellery:server:PoliceAlertMessage', "Er is een overval gaande bij Vangelico Juwelier", plyCoords, false)
