...
QBCore.Commands.Add("getintrunk", "Stap in kofferbak", {}, false, function(source, args)
    TriggerClientEvent('qb-trunk:client:GetIn', source)
end)

QBCore.Commands.Add("kidnaptrunk", "Stap in kofferbak", {}, false, function(source, args)
