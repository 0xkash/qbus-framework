        ...
        $.each(cData.messages, function(i, chat){
            ...
            $.each(cData.messages[i], function(index, message){
                ...
                if (message.type == "message") {
                    ...
                    MessageElement = '<div class="whatsapp-openedchat-message whatsapp-openedchat-message-'+Sender+' whatsapp-shared-location" data-x="'+message.data.x+'" data-y="'+message.data.y+'"><span style="font-style: italic;">Gedeelde Locatie</span><div class="whatsapp-openedchat-message-time">'+message.time+'</div></div><div class="clearfix"></div>'
                }
