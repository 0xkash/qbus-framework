...
Config.Locations = {
   ...
   ["vehicle2"] = {x = 471.13, y = -1024.05, z = 28.17, h = 274.5},
   ...
   ["trash"] = {x = 471.01, y = -988.05, z = 24.92, h = 299.5},
   ["fingerprint"] = {x = 479.64, y = -990.71, z = 24.26, h = 358.5},
   ["evidence"] = {x = 467.72, y = -992.02, z = 24.92, h = 358.5},
   ["evidence2"] = {x = 466.42, y = -988.71, z = 24.92, h = 90.5},
   ["evidence3"] = {x = 468.47, y = -988.78, z = 24.92, h = 272.5},
   ["stations"] = {
